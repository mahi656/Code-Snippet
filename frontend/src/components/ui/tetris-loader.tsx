...
// Tetris pieces - pure white for visibility on black background
const TETRIS_PIECES = [
    // I-piece
    { shape: [[1, 1, 1, 1]], color: 'bg-white shadow-[0_0_15px_rgba(255,255,255,0.9)]' },
    // O-piece
    { shape: [[1, 1], [1, 1]], color: 'bg-white shadow-[0_0_15px_rgba(255,255,255,0.9)]' },
    // T-piece
    { shape: [[0, 1, 0], [1, 1, 1]], color: 'bg-white shadow-[0_0_15px_rgba(255,255,255,0.9)]' },
    // L-piece
    { shape: [[1, 0], [1, 0], [1, 1]], color: 'bg-white shadow-[0_0_15px_rgba(255,255,255,0.9)]' },
    // S-piece
    { shape: [[0, 1, 1], [1, 1, 0]], color: 'bg-white shadow-[0_0_15px_rgba(255,255,255,0.9)]' },
    // Z-piece
    { shape: [[1, 1, 0], [0, 1, 1]], color: 'bg-white shadow-[0_0_15px_rgba(255,255,255,0.9)]' },
    // J-piece
    { shape: [[0, 1], [0, 1], [1, 1]], color: 'bg-white shadow-[0_0_15px_rgba(255,255,255,0.9)]' },
]
...
export default function TetrisLoading({
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-black overflow-hidden py-10">
            <div className="mb-6 relative">
                <div className={`border-4 border-white/20 dark:border-white/10 bg-black/40 backdrop-blur-xl ${config.padding} transition-colors rounded-xl shadow-2xl`}>
                    {renderGrid()}
                </div>
            ...
            {showLoadingText && (
                <div className="text-center mt-4">
                    <p className="text-white font-bold tracking-[0.3em] uppercase text-sm animate-pulse">{loadingText}</p>
