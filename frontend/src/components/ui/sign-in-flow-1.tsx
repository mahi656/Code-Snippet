                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="relative">
                                            <button
                                                ...
                                                className="w-full backdrop-blur-[1px] text-white border border-white/10 rounded-full py-3 px-4 focus:outline-none hover:bg-white/5 transition-colors text-center font-medium"
                                            >
                                                Log In
                                            </button>
                                        </div>
